...
Backend & Frameworks
Django · Node.js · Express · LangChain

Data & Machine Learning
scikit-learn · NLP · Isolation Forest · Feature Engineering · Model Evaluation

AI & LLM Tools
OpenAI API · Whisper · Embeddings · RAG Pipelines
...
Built a Retrieval-Augmented Generation system that converts video lectures into an interactive AI Q&A assistant

Processed and indexed lecture transcripts using embeddings for context-aware responses

Optimized chunking and retrieval logic to improve answer relevance
...
Developed and deployed a real-time fraud detection web application

Built REST APIs for transaction processing and ML inference
...
Developed scalable web applications using React, TypeScript, and Firebase

Designed role-based authentication and secure access control

Integrated backend services with Firestore for real-time data handling
